...
namespace EprocurementWeb.SatServiceReference {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="SatServiceReference.IConsultaCFDIService")]
    public interface IConsultaCFDIService {
        ...
        EprocurementWeb.SatServiceReference.Acuse Consulta(string expresionImpresa);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConsultaCFDIService/Consulta", ReplyAction="http://tempuri.org/IConsultaCFDIService/ConsultaResponse")]
        System.Threading.Tasks.Task<EprocurementWeb.SatServiceReference.Acuse> ConsultaAsync(string expresionImpresa);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IConsultaCFDIServiceChannel : EprocurementWeb.SatServiceReference.IConsultaCFDIService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConsultaCFDIServiceClient : System.ServiceModel.ClientBase<EprocurementWeb.SatServiceReference.IConsultaCFDIService>, EprocurementWeb.SatServiceReference.IConsultaCFDIService {
        ...
        public EprocurementWeb.SatServiceReference.Acuse Consulta(string expresionImpresa) {
            return base.Channel.Consulta(expresionImpresa);
        }
        
        public System.Threading.Tasks.Task<EprocurementWeb.SatServiceReference.Acuse> ConsultaAsync(string expresionImpresa) {
