var EprocurementWeb = EprocurementWeb || {};

EprocurementWeb.createNameSpace = function (namespace) {

    //get the namespace string and split it
    var namespaceArr = namespace.split('.');
    var parent = EprocurementWeb;

    // excluding the parent
    if (namespaceArr[0] === 'EprocurementWeb') {
...
EprocurementWeb.createNameSpace("EprocurementWeb.Cookies");

EprocurementWeb.Cookies.getCookie = function (ck_name) {
...
EprocurementWeb.Cookies.setCookie = function (ck_name, value, exdays) {
    var exdate = new Date();
